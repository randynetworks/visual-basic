...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("akademikDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class akademikDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As akademikDataSet = CType(MyBase.Clone,akademikDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "akademikDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/akademikDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As akademikDataSet = New akademikDataSet()
    ...
    Partial Public Class mahasiswaDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddmahasiswaRow(ByVal NPM As String, ByVal nama As String, ByVal kelas As String) As mahasiswaRow
            Dim rowmahasiswaRow As mahasiswaRow = CType(Me.NewRow,mahasiswaRow)
            Dim columnValuesArray() As Object = New Object() {NPM, nama, kelas}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindByNPM(ByVal NPM As String) As mahasiswaRow
            Return CType(Me.Rows.Find(New Object() {NPM}),mahasiswaRow)
        End Function
    ...
    Partial Public Class mahasiswaRow
        ...
        Public Property NPM() As String
            Get
                Return CType(Me(Me.tablemahasiswa.NPMColumn),String)
            End Get
            Set
                Me(Me.tablemahasiswa.NPMColumn) = value
            End Set
        End Property
        ...
        Public Function IskelasNull() As Boolean
            Return Me.IsNull(Me.tablemahasiswa.kelasColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetkelasNull()
            Me(Me.tablemahasiswa.kelasColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace akademikDataSetTableAdapters
    ...
    Partial Public Class mahasiswaTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `mahasiswa` WHERE ((`NPM` = ?) AND ((? = 1 AND `nama` IS NULL) OR (`n"& _ 
                "ama` = ?)) AND ((? = 1 AND `kelas` IS NULL) OR (`kelas` = ?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_NPM", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "NPM", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `mahasiswa` (`NPM`, `nama`, `kelas`) VALUES (?, ?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("NPM", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "NPM", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `mahasiswa` SET `NPM` = ?, `nama` = ?, `kelas` = ? WHERE ((`NPM` = ?) AND "& _ 
                "((? = 1 AND `nama` IS NULL) OR (`nama` = ?)) AND ((? = 1 AND `kelas` IS NULL) OR"& _ 
                " (`kelas` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("NPM", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "NPM", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_NPM", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "NPM", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.connectDB.My.MySettings.Default.akademikConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT NPM, nama, kelas FROM mahasiswa"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As akademikDataSet.mahasiswaDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As akademikDataSet.mahasiswaDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As akademikDataSet.mahasiswaDataTable = New akademikDataSet.mahasiswaDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As akademikDataSet.mahasiswaDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As akademikDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_NPM As String, ByVal Original_nama As String, ByVal Original_kelas As String) As Integer
            If (Original_NPM Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_NPM")
            Else
                Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_NPM,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal NPM As String, ByVal nama As String, ByVal kelas As String) As Integer
            If (NPM Is Nothing) Then
                Throw New Global.System.ArgumentNullException("NPM")
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(NPM,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal NPM As String, ByVal nama As String, ByVal kelas As String, ByVal Original_NPM As String, ByVal Original_nama As String, ByVal Original_kelas As String) As Integer
            If (NPM Is Nothing) Then
                Throw New Global.System.ArgumentNullException("NPM")
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(NPM,String)
            End If
            If (nama Is Nothing) Then
            ...
            If (Original_NPM Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_NPM")
            Else
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(Original_NPM,String)
            End If
            If (Original_nama Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal nama As String, ByVal kelas As String, ByVal Original_NPM As String, ByVal Original_nama As String, ByVal Original_kelas As String) As Integer
            Return Me.Update(Original_NPM, nama, kelas, Original_NPM, Original_nama, Original_kelas)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As akademikDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As akademikDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._mahasiswaTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As akademikDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._mahasiswaTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As akademikDataSet) As Integer
