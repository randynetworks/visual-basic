...
Partial Public Class apotikDataSet
    ...
    Partial Public Class TransaksiDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddTransaksiRow(ByVal kode As String, ByVal tanggal As String, ByVal jenis As String, ByVal harga As Integer) As TransaksiRow
            Dim rowTransaksiRow As TransaksiRow = CType(Me.NewRow,TransaksiRow)
            Dim columnValuesArray() As Object = New Object() {kode, tanggal, jenis, harga}
...
Namespace apotikDataSetTableAdapters
    ...
    Partial Public Class TransaksiTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Transaksi` (`kode`, `tanggal`, `jenis`, `harga`) VALUES (?, ?, ?, ?)"& _ 
                ""
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Transaksi` SET `kode` = ?, `tanggal` = ?, `jenis` = ?, `harga` = ? WHERE "& _ 
                "((`kode` = ?) AND ((? = 1 AND `tanggal` IS NULL) OR (`tanggal` = ?)) AND ((? = 1"& _ 
                " AND `jenis` IS NULL) OR (`jenis` = ?)) AND ((? = 1 AND `harga` IS NULL) OR (`ha"& _ 
                "rga` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.apotik.My.MySettings.Default.apotikConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT kode, tanggal, jenis, harga FROM Transaksi"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As apotikDataSet.TransaksiDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As apotikDataSet.TransaksiDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As apotikDataSet.TransaksiDataTable = New apotikDataSet.TransaksiDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As apotikDataSet.TransaksiDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_kode As String, ByVal Original_tanggal As String, ByVal Original_jenis As String, ByVal Original_harga As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal kode As String, ByVal tanggal As String, ByVal jenis As String, ByVal harga As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal kode As String, ByVal tanggal As String, ByVal jenis As String, ByVal harga As Global.System.Nullable(Of Integer), ByVal Original_kode As String, ByVal Original_tanggal As String, ByVal Original_jenis As String, ByVal Original_harga As Global.System.Nullable(Of Integer)) As Integer
            If (kode Is Nothing) Then
                Throw New Global.System.ArgumentNullException("kode")
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_tanggal,String)
            End If
            If (Original_jenis Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal tanggal As String, ByVal jenis As String, ByVal harga As Global.System.Nullable(Of Integer), ByVal Original_kode As String, ByVal Original_tanggal As String, ByVal Original_jenis As String, ByVal Original_harga As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_kode, tanggal, jenis, harga, Original_kode, Original_tanggal, Original_jenis, Original_harga)
        End Function
    End Class
